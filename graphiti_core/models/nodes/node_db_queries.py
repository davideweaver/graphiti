    ...
    match provider:
        case GraphProvider.NEPTUNE:
            return """
                ...
                entity_edges: join([x IN coalesce(episode.entity_edges, []) | toString(x) ], '|'), created_at: episode.created_at, valid_at: episode.valid_at, session_id: episode.session_id}
                RETURN n.uuid AS uuid
            """
        case GraphProvider.KUZU:
            return """
        ...
        case GraphProvider.FALKORDB:
            return """
                ...
                entity_edges: episode.entity_edges, created_at: episode.created_at, valid_at: episode.valid_at, session_id: episode.session_id}
                RETURN n.uuid AS uuid
            """
        case _:  # Neo4j
            return """
